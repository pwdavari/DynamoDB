#python file for milestone 1
#Insert script using list feature of Dynamo db

#The ingestion would be using attribute of type List feature.
#
#The schema would be :
#modelname: string
#Datadate: year+month [string]
#items : csv file as attribute of type List.

import boto

MY_ACCESS_KEY_ID = AKIAI6IH3EQDZC24J2AQ
MY_SECRET_ACCESS_KEY = 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

#AWSAccessKeyId=AKIAI6IH3EQDZC24J2AQ
#AWSSecretKey=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
